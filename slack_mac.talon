...
facepalm: insert(":facepalm:")
sad blob: insert(":sad-blob:")
spot a am: insert(":spotifam:")
melting face: insert(":melting_face:")
Lol sob: insert(":lolsob3:")
raised hands: insert(":raised_hands:")